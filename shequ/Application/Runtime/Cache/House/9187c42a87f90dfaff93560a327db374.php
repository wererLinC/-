                ...
                <div class="house-info">
                    ...
                    <div class="info-content">
                        <div class="content">
                            ...
                            姓名：<?php echo ($houseInfo["name"]); ?><br>
                            手机：<?php echo ($houseInfo["phone"]); ?><br>
                            类型：<?php echo (getRoomType($houseInfo["roomtype"])); ?><br>
                        </div>
                        <div class="content">
                            房屋地址：<?php echo ($houseInfo["address"]); ?><br>
                            楼栋号：<?php echo ($houseInfo["buildnum"]); ?><br>
                            单元号：<?php echo ($houseInfo["unitnum"]); ?><br>
                            室号：<?php echo ($houseInfo["roomnum"]); ?><br>
                        </div>
                        <div class="content">
                            所属小区：<?php echo (getCommunity($houseInfo["community"])); ?><br>
                            <br>
                            <input id="houseId" type="hidden" value="<?php echo ($houseInfo["id"]); ?>">
                            <br>
                            <div class="content-operate">
                                <a href="/index.php?m=house&c=edit&a=index&id=<?php echo ($houseInfo["id"]); ?>">修改</a><a id="del" style="cursor: pointer;margin-left: 10px;" onclick="delInfo.del()">删除</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div style="margin-top: 140px;"></div>
    ...
    <script src="/Public/js/house/delInfo.js"></script>
