    ...
    <div class="courst-content" style="height: 580px;">
        <div class="courst-contenr-border">
            ...
            <table class="table-position table  table-bordered table-hover" style="width: 100%;margin: 0 auto; ">
                ...
                <?php if(is_array($houseInfo)): $i = 0; $__LIST__ = $houseInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$houseInfo): $mod = ($i % 2 );++$i;?><tr style="font-size: 12px;color: #8C8C8C;cursor: pointer;" onclick="javascript:location.href='/index.php?m=house&c=information&a=index&id=<?php echo ($houseInfo["id"]); ?>'">
                    <td><?php echo ($houseInfo["address"]); ?></td>
                    <td><?php echo (getCommunity($houseInfo["community"])); ?></td>
                    <td><?php echo ($houseInfo["buildnum"]); ?>--<?php echo ($houseInfo["unitnum"]); ?>--<?php echo ($houseInfo["roomnum"]); ?></td>
                    <td><?php echo ($houseInfo["cardid"]); ?></td>
                    <td><?php echo ($houseInfo["name"]); ?></td>
                    <td><?php echo ($houseInfo["phone"]); ?></td>
                    <td><?php echo (getRoomType($houseInfo["roomtype"])); ?></td>
