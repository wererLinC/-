...
<hr size="5px">
    ...
    <!-- 内容开始 -->
    <div class="courst-content" style="padding: 10px;font-size: 12px;height: 400px;">
            ...
            <div class="people-info">
                <div class="car-info">
                    ...
                    <div class="info-content">
                        <div class="content">
                            身份证号码：<?php echo ($carInfo["cardid"]); ?><br>
                            姓名：<?php echo ($carInfo["name"]); ?><br>
                            电话号码：<?php echo ($carInfo["phone"]); ?><br>
                        </div>
                        <div class="content">
                            车辆品牌：<?php echo ($carInfo["carbrand"]); ?><br>
                            车牌号码：<?php echo ($carInfo["carid"]); ?><br>
                            车辆类型：<?php echo (getCarType($carInfo["cartype"])); ?><br>
                        </div>
                        <div class="content">
                            <span style="margin-right: 5px;">房屋共</span><span style="color:red; "><?php echo ($houseCount); ?></span><span style=";margin-left: 5px;">处:</span><br>
                            <?php if(is_array($houseInfo)): $i = 0; $__LIST__ = $houseInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$houseInfo): $mod = ($i % 2 );++$i;?><a style="margin-left: 30px;" href="/index.php?m=house&c=information&a=index&id=<?php echo ($houseInfo["id"]); ?>"><?php echo (getCommunity($houseInfo["community"])); ?>-<?php echo ($houseInfo["address"]); ?>-<?php echo ($houseInfo["buildnum"]); echo ($houseInfo["unitnum"]); echo ($houseInfo["roomnum"]); ?><br></a><?php endforeach; endif; else: echo "" ;endif; ?>
                            <input type="hidden" id="carInfoId" value="<?php echo ($carInfo["id"]); ?>">
                            <div class="content-operate">
                                <a href="/index.php?m=car&c=edit&a=index&id=<?php echo ($carInfo["id"]); ?>">修改</a>
                ...
                <div class="people-info-operate">
								<span class="input-group-btn">
									<button id="fanhui" style="margin-left: 30px;border-radius: 10%;" class="btn btn-success ">返回</button>
								</span>
                </div>
            </div>
        </div>
...
<!-- Bootstrap Core JavaScript -->
    ...
    <script src="/Public/js/car/delInfo.js"></script>
    <script type="text/javascript">
        //返回车辆首页
        $('#fanhui').on('click',function () {
            window.location.href='/index.php?m=car&c=list&a=index';
        })
    </script>
