...
<div class="page-container" style="min-width: 80%;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/index.php?m=charge&c=list&a=unCharge">待收费(<span style="color: red"><?php echo ($unChargeCount); ?></span>)</a></li>
                    <li class="active"><a href="/index.php?m=charge&c=list&a=charged">已收费(<span style="color: red"><?php echo ($count); ?></span>)</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="courst-content" style="height: 580px;padding: 10px;">
        ...
        <div class="courst-contenr-border">
            ...
            <div class="courst-operate"  >
                <div class="operate-item">
									<span class="input-group-btn">
										<button  class="btn btn-success" style="font-size: 12px;border-radius: 10%;" onclick="resetData.reset()">重置</button>
            ...
            <table class="table-position table  table-bordered table-hover" style="width: 100%;margin: 0 auto; ">
                ...
                <?php if($chargeInfo != null): if(is_array($chargeInfo)): $i = 0; $__LIST__ = $chargeInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chargeInfo): $mod = ($i % 2 );++$i;?><tr style="font-size: 12px;color: #8C8C8C;cursor: pointer;" onclick="javascript:location.href='/index.php?m=charge&c=information&a=index&id=<?php echo ($chargeInfo["id"]); ?>'">
                        <td><?php echo ($chargeInfo["address"]); ?></td>
                        <td><?php echo (getCommunity($chargeInfo["community"])); ?></td>
                        <td><?php echo ($chargeInfo["buildnum"]); ?>--<?php echo ($chargeInfo["unitnum"]); ?>--<?php echo ($chargeInfo["roomnum"]); ?></td>
                        <td><?php echo ($chargeInfo["name"]); ?></td>
                        <td><?php echo ($chargeInfo["time"]); ?></td>
                        <td><?php echo ($chargeInfo["money"]); ?></td>
                        <td><?php echo ($chargeInfo["admin"]); ?></td>
                    ...
                    <?php else: ?>
                    <td colspan="7">暂无信息</td><?php endif; ?>
    ...
    <script src="/Public/js/charge/resetData.js"></script>
