        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="/index.php?m=charge&c=list&a=index">添加收费(<span style="color: red"><?php echo ($count); ?></span>)</a></li>
    ...
    <div class="courst-content" style="height: 580px;padding: 10px;">
        ...
        <div class="courst-contenr-border">
            ...
            <table class="table-position table  table-bordered table-hover" style="width: 100%;margin: 0 auto; ">
                ...
                <?php if($chargeInfo != null): if(is_array($chargeInfo)): $i = 0; $__LIST__ = $chargeInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chargeInfo): $mod = ($i % 2 );++$i;?><tr style="font-size: 12px;color: #8C8C8C;cursor: pointer;">
                        ...
                        <td onclick="javascript:location.href='/index.php?m=charge&c=information&a=index&id=<?php echo ($chargeInfo["id"]); ?>'"><?php echo ($chargeInfo["phone"]); ?></td>
                        <td onclick="javascript:location.href='/index.php?m=charge&c=information&a=index&id=<?php echo ($chargeInfo["id"]); ?>'"><?php echo (getRoomType($chargeInfo["roomtype"])); ?></td>
