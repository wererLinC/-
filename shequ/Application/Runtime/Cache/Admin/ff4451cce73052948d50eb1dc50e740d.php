...
<!--TODO-->
					<div class="imgListDiv" style="width: 80%;height: 500px;margin: 0 auto;margin-right:100px;border: 1px solid #FFFFFF">
						...
						<hr>
						<!-- 操作结束 -->
						<?php if(is_array($imgInfo)): $i = 0; $__LIST__ = $imgInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imgInfo): $mod = ($i % 2 );++$i;?><div class="content-item" style="border-radius: 5%;width: 133px;height: 150px;">
