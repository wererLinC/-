        ...
        <div class="courst-content-item">
            <div class="addHouse-content">
                <div style="height: 100%;width: 600px;margin: 0 auto;margin-top: 30px;">
                    <form role="form" id="fileInfo" enctype="multipart/form-data">
                        <input type="hidden" name="uploadAdmin" value="<?php echo ($_SESSION['admin']['name']); ?>">
                        <div class="form-group ">
                            <div class="input-group">
                                <span  class="input-group-addon">文件通知</span>
                                <input  type="text" class="form-control"  name="fileNote" placeholder="文件通知事项">
                            </div>
                        </div>
                        <input id="fileName" type="hidden" class="form-control"  name="fileName" value="">

                        <div class="form-group">
                            <div class="input-group">
                                <span style="font-size: 12px;" class="input-group-addon ">上传文件</span>
                                <input id="uploadfile"  type="file" name="thumb"  data-show-preview="false">
                                <input name="url" value="" id="file_upload" type="hidden">
                            </div>
                            <span style="font-weight: bold;color:#F7B52C;position: absolute;top: 50px;" id="fileNameShow" ></span>
                        </div>

                    </form>
                </div>
                <div class="addHouse-operate" style="bottom:80px;">
                    <button class="btn btn-success" style="border-radius:10%;margin-left: 140px;"  onclick="addInfo.add()">确定</button>
