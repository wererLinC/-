...
<div class="page-container" style="min-width: 80%;">
        ...
        <div class="courst-content-item">
            <div class="addHouse-content">
                <div style="height: 100%;width: 600px;margin: 0 auto;margin-top: 30px;">
                    <form role="form" id="editAdminInfo" >
                        <div class="form-group ">
                            <div class="input-group">
                                <span class="input-group-addon">身份证号码</span>
                                <input type="text" class="form-control"  name="cardId" value="<?php echo ($adminInfo["cardid"]); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"  name="name" value="<?php echo ($adminInfo["name"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"  name="phone" value="<?php echo ($adminInfo["phone"]); ?>">
                            </div>
                        </div>
                        <!-- 校验用 -->
                        <div class="form-group">
                            <div class="input-group  ">
                                <span class="input-group-addon ">部门/职务</span>
                                <input type="text" class="form-control"  name="position" value="<?php echo ($adminInfo["position"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon ">户籍地</span>
                                <input type="text" class="form-control"  name="birthLand" value="<?php echo ($adminInfo["birthland"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group  ">
                                ...
                                <select  name="sex" data-toggle="select" class="form-control select select-warning mrs">
                                    <?php if($adminInfo["sex"] == 1): ?><option value="1" selected>男</option><?php else: ?><option value="1">男</option><?php endif; ?>
                                    <?php if($adminInfo["sex"] == 2): ?><option value="2" selected>女</option><?php else: ?><option value="2">女</option><?php endif; ?>
                                </select>
                                <span class="input-group-addon ">党员</span>
                                <select  name="policy" data-toggle="select" class="form-control select select-warning mrs">
                                    <?php if($adminInfo["policy"] == 1): ?><option value="1" selected>是</option><?php else: ?><option value="1">是</option><?php endif; ?>
                                    <?php if($adminInfo["policy"] == 2): ?><option value="2" selected>否</option><?php else: ?><option value="2">否</option><?php endif; ?>
                                </select>
                            </div>
                        </div>
                        <input type="hidden" name="adminType" value="0">
                        <input type="hidden" name="id" value="<?php echo ($adminInfo["id"]); ?>">
                    </form>
                </div>
                <div class="addHouse-operate" style="bottom: -40px;">
                    <button class="btn btn-success" style="border-radius:10%;margin-left: 250px;"  onclick="editInfo.edit()">确定</button>
    ...
    <script src="/Public/js/admin/editInfo.js"></script>
