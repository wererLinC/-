            ...
            <div>
                <ul class="nav navbar-nav">
                    ...
                    <?php else: ?>
                        ...
                        <li ><a href="/index.php?m=task&c=list&a=completing">待处理(<span style="color: #d58512;"><?php echo ($completingCount); ?></span>)</a></li><?php endif; ?>
                        <li class="active"><a href="/index.php?m=task&c=list&a=register">登记事件(<span style="color: #d58512;"><?php echo ($registerCount); ?></span>)</a></li>
            ...
            <div class="renwu">
                ...
                <div class="task">
                    ...
                    <div class="taskContent">
                        ...
                        <?php if(is_array($taskInfo)): $i = 0; $__LIST__ = $taskInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$taskInfo): $mod = ($i % 2 );++$i;?><div class="taskItemContent" style="font-size: 12px;">
