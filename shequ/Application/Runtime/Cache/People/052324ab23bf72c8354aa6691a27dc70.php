            ...
            <div class="people-info">
                <div class="renyuan-info">
                    ...
                    <div class="info-content">
                            ...
                            <div class="content">
                                <span style="margin-right: 5px;">房屋:</span><br>
                                    <a style="margin-left: 30px;" href="/index.php?m=house&c=information&a=index&id=<?php echo ($houseInfo["id"]); ?>"><?php echo (getCommunity($houseInfo["community"])); ?>-<?php echo ($houseInfo["address"]); ?>-<?php echo ($houseInfo["buildnum"]); echo ($houseInfo["unitnum"]); echo ($houseInfo["roomnum"]); ?><br></a>
                            <input id="peopleId" type="hidden" value="<?php echo ($peopleInfo["id"]); ?>">
                            <br>
                            <div class="content-operate">
                                <a href="/index.php?m=people&c=edit&a=zanzhu&id=<?php echo ($peopleInfo["id"]); ?>">修改</a><a id="del" style="cursor: pointer;margin-left: 10px;" onclick="delZanZhuInfo.del()">迁出</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="people-info-operate">
								<span class="input-group-btn">
									<a style="margin-left: 30px;border-radius: 10%;" class="btn btn-success " href="/index.php?m=people&c=list&a=zanzhu" >返回</a>
								</span>
                </div>
            </div>
...
<!-- Bootstrap Core JavaScript -->
    ...
    <script src="/Public/js/people/delZanZhuInfo.js"></script>
