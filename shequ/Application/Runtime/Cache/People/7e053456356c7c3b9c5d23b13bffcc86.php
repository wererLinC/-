   ...
   <!--/content-inner-->
    ...
    <div class="courst-bread" style="margin-top: 20px;">
        <ol class="breadcrumb">
            ...
            <li><a href="/index.php?m=people&c=list&a=qianchu">人员管理</a></li>
...
<hr size="5px">
    ...
    <div class="courst-content" style="height: 450px;">
        <?php if($peopleInfo != null): ?><div class="courst-content-item" style="width: 1100px;">
            <?php if(is_array($peopleInfo)): $i = 0; $__LIST__ = $peopleInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$peopleInfo): $mod = ($i % 2 );++$i;?><!-- 人员信息 -->
                <div id="content-item" class="content-item" style="width: 300px;">
