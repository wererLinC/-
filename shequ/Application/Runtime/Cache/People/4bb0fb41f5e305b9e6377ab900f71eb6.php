        ...
        <div class="courst-content-item">
            <div class="addHouse-content">
                    ...
                    <form role="form" id="zanZhuInfo" >
                        ...
                        <div class="form-group">
                            <div class="input-group  ">
                                ...
                                <input  style="font-size: 10px;width: 82px;"  type="text" class="form-control"  name="buildNum" placeholder="楼栋号">

                                <span style="font-size: 10px;" class="input-group-addon ">单元号</span></span>
                                <input  style="font-size: 10px;width: 82px;"  type="text" class="form-control"  name="unitNum" placeholder="单元号">

                                <span style="font-size: 10px;" class="input-group-addon ">室号</span>
                                <input style="font-size:10px;width: 82px;"  type="text" class="form-control"  name="roomNum" placeholder="室号">
                        ...
                        <div class="form-group">
                            <div class="input-group  ">
                                ...
                                <input style="font-size: 10px;" type="text" class="form-control"  name="cardId" placeholder="请输入身份证">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group  ">
                                ...
                                <input style="font-size: 10px;" type="text" class="form-control"  name="name" placeholder="请输入姓名">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group  ">
                                <span style="font-size: 10px;" class="input-group-addon ">电话</span>
                                <input style="font-size: 10px;" type="text" class="form-control"  name="phone" placeholder="请输入电话">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group  ">
                                <span style="font-size: 10px;" class="input-group-addon ">工作单位</span>
                                <input style="font-size: 10px;" type="text" class="form-control"  name="workLand" placeholder="请输入工作单位">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group  ">
                                <span style="font-size: 10px;" class="input-group-addon ">户籍地</span>
                                <input style="font-size: 10px;" type="text" class="form-control"  name="birthLand" placeholder="请输入户籍地">
                            </div>
                        </div>
                        <!-- 手机验证 -->
                        <div class="form-group">
				...
				<span style="font-size: 10px;" class="input-group-addon ">性别</span>
                                <select style="font-size: 10px;" name="sex" data-toggle="select" class="form-control select select-warning mrs">
                ...
                <div class="addHouse-operate" style="bottom: -85px;">
								<span class="input-group-btn">
									<button class="btn btn-success" style="margin-left: 140px;border-radius: 10%;" onclick="addZanZhuInfo.add()">确定</button>
...
<!-- Bootstrap Core JavaScript -->
    ...
    <script src="/Public/js/people/addZanZhuInfo.js"></script>
