        ...
        <div class="courst-operate" style="padding: 0px;margin-top: 10px;" >
            <div class="operate-item">
									<span class="input-group-btn">
										...
										<button  style="margin-left: 30px;border-radius: 10%;font-size: 12px" class="btn btn-success " onclick="javascript:location.href='/index.php?m=people&c=excel&a=huji'">导入</button>
									</span>
            </div>
...
<!-- Bootstrap Core JavaScript -->
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $(".hujiPeopleTable #operateBut").on('click',function () {
        ...
        $('#addpeople').on('click',function () {
            window.location.href='/index.php?m=people&c=add&a=huji';
        });
