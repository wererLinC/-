        ...
        <div class="inner-content">
            ...
            <div class="courst-bread" style="margin-top: 20px;">
                <ol class="breadcrumb">
                    ...
                    <li><a href="/index.php?m=people&c=list&a=huji">人员管理</a></li>
                    <li class="active">户籍户导入</li>
                </ol>
            </div>
            <hr size="5px">
                ...
                <div class="courst-content-item">
                    <div class="addHouse-content">
                        <div style="height: 100%;width: 600px;margin: 0 auto;margin-top: 30px;">
                            <form method="post" action="/index.php?m=people&c=excel&a=addHuji" enctype="multipart/form-data">
