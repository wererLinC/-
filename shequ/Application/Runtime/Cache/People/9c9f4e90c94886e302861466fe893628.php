        ...
        <div class="courst-operate" style="padding: 0px;margin-top: 10px;" >
            <div class="operate-item">
									<span class="input-group-btn">
										...
										<button  style="margin-left: 30px;border-radius: 10%;font-size: 12px" class="btn btn-success " onclick="javascript:location.href='/index.php?m=people&c=excel&a=zanzhu'">导入</button>
									</span>
            </div>
            ...
            <?php if(is_array($peopleInfo)): $i = 0; $__LIST__ = $peopleInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$peopleInfo): $mod = ($i % 2 );++$i;?><!-- 人员信息 -->
                <div id="content-item" class="content-item zanzhuPeopleTable" style="width: 300px;">
                    ...
                    <div id="content-item-operate" class="content-item-operate">
                        <a href="/index.php?m=people&c=edit&a=zanzhu&id=<?php echo ($peopleInfo["id"]); ?>">修改资料</a>&nbsp;&nbsp;
